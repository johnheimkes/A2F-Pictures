 ...
 * @version $Id$
 */
add_action('init', array('NERD_Gallery', 'init'));
/**
 * NERD_Gallery
 *
 * @package NERD_Gallery
 * @author Jess Green <jgreen@nerdery.com>
 */
class NERD_Gallery
{
    ...
    public static function init()
    {
        ...
        add_shortcode('gallery', array('NERD_Gallery', 'gallery_shortcode'));
    ...
    public static function gallery_shortcode($src, $attr)
    {
        ...
        $gallery_attrs   = self::_nerdery_gallery_set_arguments($attr, $post->ID);
        $post_attachment = self::_nerdery_get_post_attachments($gallery_attrs);
        ...
        /**
         * Creates a hook called nerdery-gallery_template, which will permit plugins
        ...
        // grab our template
        ob_start();        
        require get_query_template('nerdery-gallery', array('views/gallery.php'));
     ...
     * @return array
     */
    private static function _nerdery_gallery_set_arguments($args, $post_ID)
    {
     ...
     */
    private static function _nerdery_get_post_attachments($attrs)
    {
