...
if (!defined('NERDERY_TWITTER_ABSPATH'))
    define('NERDERY_TWITTER_ABSPATH', plugin_dir_path(__FILE__));

if (!defined('NERDERY_TWITTER_URLPATH'))
    define('NERDERY_TWITTER_URLPATH', plugin_dir_url(__FILE__));
...
{
    /**
     * Twitter User timeline Endpoint
     *
     * @var string
     */
    const TWITTER_USER_TIMELINE = 'statuses/user_timeline';
    ...
    public static function do_activate()
    {
        ...
        if (version_compare(self::$version, NERDERY_TWITTER_VERSION, '<')
                && !(self::$version == '')) {
