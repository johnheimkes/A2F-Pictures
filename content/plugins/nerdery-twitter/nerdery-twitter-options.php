...
class Nerdery_Twitter_Options
{
    ...
    /**
     * Options init. Handle register_settings and add_settings_section
     *
     * @return void
     */
    ...
    /**
     * Callback method for add_menu_page
     *
     * @return void
     */
    ...
    public function set_options_fields($fields = array())
    {
        $new_options = array(
            ...
            'twitter_oauth' => array(
                'consumer_key'     => array(
                    'id'    => 'consumer-key',
                    'title' => __('Consumer Key', NERDERY_TWITTER_DOMAIN),
                    'description' => '',
                    'type'  => 'text',
                    'valid' => 'string',
                    'default' => '',
