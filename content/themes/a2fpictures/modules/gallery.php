...
class A2F_Gallery
{
    ...
    public static function init()
    {
        ...
        add_shortcode('gallery', array('A2F_Gallery', 'gallery_shortcode'));
    ...
    public static function gallery_shortcode($src, $attr)
    {
        ...
        $gallery_attrs   = self::_a2f_gallery_set_arguments($attr, $post->ID);
        $post_attachment = self::_a2f_get_post_attachments($gallery_attrs);
        ...
        /**
         * Creates a hook called a2f-gallery_template, which will permit plugins
        ...
        // grab our template
        ob_start();        
        require get_query_template('a2f-gallery', array('views/gallery.php'));
     ...
     * @return array
     */
    private static function _a2f_gallery_set_arguments($args, $post_ID)
    {
     ...
     */
    private static function _a2f_get_post_attachments($attrs)
    {
